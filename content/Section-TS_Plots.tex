...
%   Hints:
%     \begin{itemize}
%       \item Load the required package \ttfamily datasets\normalfont for this exercise.
%       \item Load the data set \ttfamily presidents.\normalfont
%       \item Convert the data set to be into matrix format, one row per year:
%           \begin{lstlisting}
%             presidents_mat = matrix(presidents, ncol=4, byrow=TRUE)
%           \end{lstlisting}
