...
\newpage
\begin{description}
  \item[R Graphics Gallery:] {\small \textit{\urlwofont{http://research.stowers-institute.org/efg/R/}}}
  \item[R Graph Gallery:]  {\small \textit{\urlwofont{http://addictedtor.free.fr/graphiques/}}}
  \item[Book:] {\small \textit{\urlwofont{http://book.flowingdata.com/}}}
  \item[Book:] 'Interactive Data Visualization' (O'Reilly)
  \item[Bokeh:] {\small \textit{\urlwofont{http://bokeh.pydata.org/en/latest/}}}
  \item[Stacked graph:] {\small \textit{ \urlwofont{http://menugget.blogspot.com/2013/12/data-mountains-and-streams-stacked-area.html}}}
  \item[Blog:] {\small \textit{\urlwofont{http://spatial.ly/}}}      
...
\begin{frame}[allowframebreaks]
  \begin{itemize}
    ...
    \item[11.] Heiberger, R. M. (2016, February). Design of Not-Simple Graphs. Talk presented at the 
     ...
     \item[14.] \url{http://ggvis.rstudio.com/interactivity.html}
     \item[15.] \url{https://github.com/smbache/magrittr}
  \end{itemize}
\end{frame}
% ggvis tutorial: http://www.londonr.org/presentations/2014/11/LondonR_-_Introduction_to_ggvis_-_Aimee_Gott_-_20141125.pdf
